...
final class CorrectionCubeTests: XCTestCase {
    ...
    private var cases: [(String, Look.Correct)] {
        [
            ...
            (
                "a full CDL",
                .init(
                    slope: "1.1,0.95,1.02", offset: "0.01,-0.02,0.005",
                    power: "0.9,1.0,1.15")
            ),
    ...
    func testItRefusesWhatTheGeneratorRefuses() {
        XCTAssertNil(
            CorrectionCube.cube(for: .init(power: "0,1,1"), size: 33),
            "a zero power is refused by the generator")
        XCTAssertNil(
            CorrectionCube.cube(for: .init(slope: "1,1"), size: 33),
    ...
    private var cases: [(String, Look.Tone)] {
        [
            (
                "shipped",
                .init(
                    gamma: 2.02, pivot: 0.39, contrast: 1.09, toe: 0, shoulder: 0.1,
                    black: 0.025)
            ),
            ...
            (
                "deep toe",
                .init(
                    gamma: 1.4, pivot: 0.25, contrast: 1.6, toe: 0.8, shoulder: 0,
                    black: -0.08)
            ),
            (
                "hard shoulder",
                .init(
                    gamma: 2.6, pivot: 0.65, contrast: 0.8, toe: 0, shoulder: 0.8,
                    black: 0.08)
            ),
            (
                "both",
                .init(
                    gamma: 1.8, pivot: 0.5, contrast: 1.3, toe: 0.5, shoulder: 0.5,
                    black: 0.02)
            ),
        ]
    }
